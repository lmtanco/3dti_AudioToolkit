...
bool bEnableReverb = true;
 ...
 int main()
 {
	...
	if(audio->openStream(&outputParameters,     // Specified output parameters
                      ...
                      {
                            // Print RtAudio Error to standard output and exit the program
                            std::cout << "Error opening audio rt stream: " << std::endl;
    	                    exit( 0 );
                      }

// testHL-06c: forensic comparison of two band-limit configurations of the
// Gammatone hearing loss simulator, using the same audiometry (Moderate condition of the validation experiment):
//
...
//    -> testHL-06c-bandConfig.mat
//  - the stereo outputs for inputs scaled x0.5, x1, x2, x4, x8
//    -> testHL-06c-stereoOutputs.mat
...
int main()
{
    ...
    // Moderate condition of the validation experiment (see hl-validation-app,
    // ofApp::SetAudiometryModerate). Intended for the clinical frequencies
    // {250, 500, 1000, 2000, 3000, 4000, 6000, 8000}.
    std::vector<float> audiometryLeft  = {15, 5, 15, 40, 55, 65, 70, 55};
    std::vector<float> audiometryRight = {15, 5, 15, 45, 55, 60, 55, 85};
    ...
    {
        matioCpp::File file = matioCpp::File::Create("testHL-06c-bandConfig.mat");
    ...
    {
        matioCpp::File file = matioCpp::File::Create("testHL-06c-stereoOutputs.mat");

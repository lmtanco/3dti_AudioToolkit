// testHL-06d: forensic comparison of two band-limit configurations of the
// Gammatone hearing loss simulator, using the same audiometry (Severe condition of the validation experiment):
//
...
//    -> testHL-06d-bandConfig.mat
//  - the stereo outputs for inputs scaled x0.5, x1, x2, x4, x8
//    -> testHL-06d-stereoOutputs.mat
...
int main()
{
    ...
    // Severe condition of the validation experiment (see hl-validation-app,
    // ofApp::SetAudiometrySevere). Intended for the clinical frequencies
    // {250, 500, 1000, 2000, 3000, 4000, 6000, 8000}.
    std::vector<float> audiometryLeft  = {40, 35, 45, 75, 65, 80, 80, 85};
    std::vector<float> audiometryRight = {30, 25, 50, 75, 75, 85, 80, 85};
    ...
    {
        matioCpp::File file = matioCpp::File::Create("testHL-06d-bandConfig.mat");
    ...
    {
        matioCpp::File file = matioCpp::File::Create("testHL-06d-stereoOutputs.mat");

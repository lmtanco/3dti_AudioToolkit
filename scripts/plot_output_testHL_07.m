function plot_output_testHL_07()

   % HL_DBS_SPL_FOR_0_DBS_FS=100;
    
    inputData = open('../build/Debug/testHL-07-input.mat');
    outputData = open('../build/Debug/testHL-07-output.mat');
    individualFilterOutputData = open('../build/Debug/testHL-07-filterOutputs.mat');
    bandIndicesData = open('../build/Debug/testHL-07-bandIndices.mat');
   % stereoOutputsData = open('../build/Debug/testHL-07-stereoOutputs.mat');
    bandLimitsData = open('../build/Debug/testHL-07-bandLimits.mat');
    ...
    % Load actual band limits
    bandLimits = bandLimitsData.bandLimits
    % Compute band centers from band limits
    bandCenters = sqrt(bandLimits(1:end-1) .* bandLimits(2:end))
